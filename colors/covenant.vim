...
set t_Co=256
let colors_name = "covenant"

hi Comment	    guifg=#ffadac    ctermfg=214    gui=bold    cterm=bold 
hi Constant	    guifg=#f4e0ff    ctermfg=255    gui=none    cterm=none 
...
hi LineNr	    guifg=#ffadac    ctermfg=214    gui=none    cterm=none 
hi MatchParen	    guifg=#ccffcc    ctermfg=252    guibg=#008b8b    ctermbg=33    gui=none    cterm=none 
hi Normal	    guifg=#ffffff    ctermfg=231    guibg=#0d0a18    ctermbg=232    gui=none    cterm=none 
hi NonText	    guibg=#444444    ctermbg=239    guifg=#81bed6    ctermfg=89    gui=none    cterm=none 
hi Number	    guifg=#d49fff    ctermfg=160    gui=none    cterm=none 
hi PreProc	    guifg=#8fe7c8    ctermfg=245    gui=none    cterm=none 
hi Statement	    guifg=#dd97c9    ctermfg=253    gui=none    cterm=none 
...
hi StorageClass	    guifg=#8bf2fd    ctermfg=245    gui=none    cterm=none 
hi Title	    guifg=#cd5c5c    ctermfg=252    gui=bold    cterm=bold 
hi Todo	    guifg=#fffefc    ctermfg=226    gui=none    cterm=none 
hi Type	    guifg=#dd97c9    ctermfg=253    gui=none    cterm=none 
